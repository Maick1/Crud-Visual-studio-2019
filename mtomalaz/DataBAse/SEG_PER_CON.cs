...
namespace mtomalaz.DataBAse
{
    ...
    public partial class SEG_PER_CON
    {
        public int SEG_PER_CON_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int PER_Id_Periodo { get; set; }
        public int ENT_Id_Entidad { get; set; }
        public System.DateTime PER_Fecha { get; set; }
        public double PER_Valor { get; set; }
