...
namespace mtomalaz.DataBAse
{
    ...
    public partial class GEN_PRM_GEOA_PAISES
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public GEN_PRM_GEOA_PAISES()
        {
        ...
        public string Gen_PrmPai_Codigo { get; set; }
        public string Gen_PrmPai_Nombre { get; set; }
        public string Gen_PrmPai_CodTelefono { get; set; }
        public string Gen_PrmPai_Nacionalidad { get; set; }
        public string Gen_PrmPai_CodigoSri { get; set; }
        public string Gen_PrmPai_COI { get; set; }
        public string Gen_PrmPai_Dominio { get; set; }
        public string Gen_PrmPai_ISO_Alpha2 { get; set; }
        public string Gen_PrmPai_ISO_Alpha3 { get; set; }
        public string Gen_PrmPai_ISO_Numerico { get; set; }
