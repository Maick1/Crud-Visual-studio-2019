...
namespace mtomalaz.DataBAse
{
    ...
    {
        public int SEG_MENU_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int MEN_Id_Menu { get; set; }
        public string MEN_Descripcion { get; set; }
        public string MEN_Nivel { get; set; }
        public string MEN_Tipo { get; set; }
        public string MEN_Direccion { get; set; }
        public string MEN_Ingreso { get; set; }
        public string MEN_Multiple { get; set; }
        public string MEN_Reporte { get; set; }
        public string MEN_Ruta { get; set; }
