...
namespace mtomalaz.DataBAse
{
    ...
    public partial class SEG_NIVEL_PRECIO
    {
        public int SEG_NIVEL_PRECIO_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int NIV_Id_Precio { get; set; }
        public string NIV_Tipo { get; set; }
        public double NIV_Porcentaje { get; set; }
        public string NIV_Estado { get; set; }
