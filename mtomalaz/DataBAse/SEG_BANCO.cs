...
namespace mtomalaz.DataBAse
{
    ...
    public partial class SEG_BANCO
    {
        public int SEG_BANCO_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int BAN_Id_Banco { get; set; }
        public string BAN_Descripcion { get; set; }
        public string BAN_Direccion { get; set; }
        public string BAN_Tipo { get; set; }
        public string BAN_Estado { get; set; }
