...
namespace mtomalaz.DataBAse
{
    ...
    public partial class INV_CAB_SOLICITUD
    {
        public int SOL_Solicitud_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public string SOL_Solicitud_Reg { get; set; }
        public System.DateTime SOL_Fec_Solicitud { get; set; }
