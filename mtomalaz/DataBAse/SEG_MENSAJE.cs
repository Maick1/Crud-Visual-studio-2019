...
namespace mtomalaz.DataBAse
{
    ...
    public partial class SEG_MENSAJE
    {
        public int SEG_MENSAJE_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int MSJ_Id_Mensaje { get; set; }
        public string MSJ_Descripcion { get; set; }
        public string MSJ_Estado { get; set; }
