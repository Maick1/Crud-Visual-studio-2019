...
namespace mtomalaz.DataBAse
{
    ...
    public partial class SEG_IMP_BEN
    {
        public int SEG_IMP_BEN_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int IMB_Id_Impben { get; set; }
        public string IMB_Descripcion { get; set; }
        public string IMB_Tipo { get; set; }
        public double IMB_Porcentaje { get; set; }
        public double IMB_Valor { get; set; }
        public string IMB_Estado { get; set; }
