...
namespace mtomalaz.DataBAse
{
    ...
    public partial class COM_CAB_DEV
    {
        public int CAB_Devolucion_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int CAB_Id_Orden { get; set; }
        public int CAB_Id_PPersona { get; set; }
        public int CAB_Id_EPersona { get; set; }
        public System.DateTime CAB_FechaCompra { get; set; }
        public System.DateTime CAB_FechaDevolucion { get; set; }
