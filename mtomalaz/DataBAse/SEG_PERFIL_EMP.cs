...
namespace mtomalaz.DataBAse
{
    ...
    public partial class SEG_PERFIL_EMP
    {
        public int SEG_PERFIL_EMP_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int PEM_Id_Perfil { get; set; }
        public string PEM_Descripcion { get; set; }
        public string PEM_Trm_i { get; set; }
        public string PEM_Trm_m { get; set; }
        public string PEM_Trm_e { get; set; }
        public string PEM_Trm_c { get; set; }
        public string PEM_Trm_r { get; set; }
