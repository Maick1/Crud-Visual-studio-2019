...
namespace mtomalaz.DataBAse
{
    ...
    public partial class SEG_INICIO
    {
        public int SEG_INICIO_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public string USU_Login { get; set; }
        public string INI_Modulo { get; set; }
        public string USU_Pasword { get; set; }
        public string INI_Estado { get; set; }
