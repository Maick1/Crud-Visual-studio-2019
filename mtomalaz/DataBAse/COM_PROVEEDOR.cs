...
namespace mtomalaz.DataBAse
{
    ...
    public partial class COM_PROVEEDOR
    {
        public int ENT_Id_Entidad { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int PRO_Secuencial { get; set; }
        public int SEG_Id_Tipo { get; set; }
        public int SEG_Id_Banco { get; set; }
        public Nullable<int> PRO_Categoria { get; set; }
