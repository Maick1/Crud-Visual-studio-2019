...
namespace mtomalaz.DataBAse
{
    ...
    public partial class INV_DET_KARDEX
    {
        public int KAR_Id_Kardex_Det { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int KAR_Id_Kardex { get; set; }
        public int KAR_Secuencial { get; set; }
        public int KAR_Ingreso { get; set; }
        public int KAR_Egreso { get; set; }
        public int ART_Id_Articulo { get; set; }
