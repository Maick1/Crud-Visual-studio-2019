...
namespace mtomalaz.DataBAse
{
    ...
    public partial class COM_DET_DEV
    {
        public int DET_Devolucion_Id { get; set; }
        public int EMP_Id_Empresa { get; set; }
        public int CAB_Devolucion_Id { get; set; }
        public int CAB_Orden_Cab_Id { get; set; }
        public int CAT_Prov_Id { get; set; }
        public int DET_Secuencial { get; set; }
        public string DET_Producto { get; set; }
        public double DET_Costo { get; set; }
